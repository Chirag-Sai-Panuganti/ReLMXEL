...
- **gamma (γ=0.9)**: Discount factor for RL, tuned from **{0.9, 0.95, 0.99}**.
- **alpha (α=0.1)**: Learning rate for the RL agent, tuned across **{0.01, 0.1, 0.3, 0.5, 0.6, 0.7, 0.8}**.
